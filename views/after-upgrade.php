<div class="wrap">
	...
	<p>
    	<a href="http://www.tidioelements.com/editor/<?php echo $tidioAutomationOptions->getPublicKey() ?>?userAccessKey=<?php echo TidioPluginUpgrade::getUserAccessKey() ?>&userLoginSession=1#plugin,automation,openSettings" class="button button-primary" target="_blank">Przejdź do <strong>edycji wyglądu</strong></a>
    	<a href="http://www.tidioelements.com/en/panel/plugins/automation?userAccessKey=<?php echo TidioPluginUpgrade::getUserAccessKey() ?>&userLoginSession=1" class="button button-primary" target="_blank">Przejdź do <strong>panelu zarządzania</strong></a>
    </p>
